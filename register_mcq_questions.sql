...
CREATE TABLE `mcq_questions` (
  ...
  CONSTRAINT `mcq_questions_ibfk_1` FOREIGN KEY (`assignment_id`) REFERENCES `book_assignment` (`assignment_id`) ON DELETE CASCADE
...
INSERT INTO `mcq_questions` VALUES (2,3,'What is the capital of France?','Berlin','Madrid','Paris','Rome','C');
